import type { FormatBirdConfigOptions, ResolvedFormatOptions } from "./types.js";
...
export const resolveOptions = (options: FormatBirdConfigOptions = {}): ResolvedFormatOptions => ({
